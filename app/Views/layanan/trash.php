...
<div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div>
        <h4><i class="bi bi-trash3 me-2" style="color:#ef4444;"></i>Tong Sampah - Layanan</h4>
...
<div class="card">
    <div class="card-header">
        <span style="font-weight:600; color:#fca5a5;">
            <i class="bi bi-trash3 me-1"></i> Data Layanan Terhapus (Soft Delete)
        </span>
    </div>
    <div class="card-body p-0">
        ...
        <div class="text-center py-5">
            ...
            <p class="mt-3" style="color:#64748b;">Tong sampah kosong. Tidak ada data yang dihapus.</p>
        </div>
        <?php else: ?>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="color:#94a3b8; text-decoration: line-through;"><?= esc($item['nama_layanan']) ?></td>
                        <td><span style="color:#64748b;">Rp <?= number_format($item['harga'], 0, ',', '.') ?></span></td>
                        <td><span style="color:#64748b;"><?= $item['estimasi_hari'] ?> Hari</span></td>
                        <td>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <button type="button" class="btn btn-sm"
                                    ...
                                    onclick="confirmRestore('/layanan/restore/<?= $item['id'] ?>', '<?= esc($item['nama_layanan']) ?>')">
                                    <i class="bi bi-arrow-counterclockwise me-1"></i> Pulihkan
                                </button>
                                <button type="button" class="btn btn-sm"
                                    style="background:rgba(239,68,68,0.15); border:1px solid rgba(239,68,68,0.3); color:#fca5a5;"
                                    onclick="confirmForceDelete('/layanan/force-delete/<?= $item['id'] ?>', '<?= esc($item['nama_layanan']) ?>')">
